...
> **หมายเหตุ:** ก่อนหน้านี้ `PLATFORM_COMPONENTS.md` และ `DEPLOYMENT_ARCHITECTURE.md`
> อ้างอิงหัวข้อนี้เป็น "ENTERPRISE_ARCHITECTURE.md ข้อ 6" ซึ่งไม่มีอยู่จริง — แก้ไขแล้ว
> ให้ทั้งสองไฟล์อ้างอิงมาที่หัวข้อนี้แทน

⚠️ **สถานะ: ยังไม่ตัดสินใจ (Open Decision)** — ตัวเลือกที่กำลังพิจารณาอยู่:

1. **Firestore project แยกต่อ tenant** — สร้าง Service Account/Firestore แยกต่อราย
   ตามที่ Setup Wizard ของ Dynamic Command Center (Platform Shell) ออกแบบไว้คร่าวๆ
2. **Firestore project เดียว แยกด้วย field/collection prefix ต่อ tenant**

การตัดสินใจสุดท้ายต้องบันทึกเป็น ADR ใหม่ (เช่น ADR-0010) ตามกฎใน
`CLOUDFORGE_CONSTITUTION.md` ข้อ 8 เนื่องจากกระทบมากกว่า 1 component (Data Layer,
App 1, App 2, App 3/Platform Shell)

ดูรายละเอียดเพิ่มเติมที่ `DEPLOYMENT_ARCHITECTURE.md` หัวข้อ 1.3 และ Open Decisions
